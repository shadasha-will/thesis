...
corpus: Corpus = ColumnCorpus(data_folder, columns, 
                              train_file = 'data_gene_new_train.tsv',
                              test_file = 'data_gene_new_test.tsv',
                              dev_file = 'data_gene_new_valid.tsv')
...
trainer.train('/content/drive/MyDrive/thesis/resources/taggers/ner_gene_elmo', learning_rate=0.1, mini_batch_size=32,
